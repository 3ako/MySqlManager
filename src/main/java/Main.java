...
public class Main {
    public static void main (String[] args) throws SQLException {
        ...
        MySqlServer mySqlServer = manager.registerServer("116.202.131.195", "admin", "f0UeZD5g8HUkWPwIf2bF0sqJx6lZbm7k");
        mySqlServer.startUi();
        mySqlServer.connect();
        mySqlServer.registerAllDatabases();
        MySqlDatabase base = mySqlServer.getBaseByName("authme");
        ResultSet rs = base.getOne("SELECT * FROM authme;");
        System.out.println("Вывод: "+rs.getString(1));
    }
}
